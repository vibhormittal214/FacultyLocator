...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String name1;
    String eid1;
    String subject1,email,password;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subject = (EditText) findViewById(R.id.entersub);
    ...
    private void registerUser(){
        ...
        if(TextUtils.isEmpty(eid1)){
            Toast.makeText(this,"Please enter id number",Toast.LENGTH_LONG).show();
            return;
        }
        ...
        progressDialog.show();
        current_user_db2 = FirebaseDatabase.getInstance().getReference().child("users").child("teacherdata");
        current_user_db2.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChild(eid1)) {
                    Toast.makeText(MainActivity.this,"this faculty id already exist",Toast.LENGTH_SHORT).show();
                            ...
                            .addOnCompleteListener(MainActivity.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if(task.isSuccessful()){
                                        ...
                                        User1 user = new User1(name1,eid1,subject1," "," "," ");
                                        current_user_db.setValue(user);
                                        DatabaseReference current_user_db1 = FirebaseDatabase.getInstance().getReference().child("users").child("teacherdata").child(eid1);
                                        User2 user2=new User2(" "," "," ",name1,subject1);
